...
class _$_LoginData implements _LoginData {
  const _$_LoginData({required this.id, this.isImportant = true});
  ...
  @override
  String toString() {
    return 'LoginData(id: $id, isImportant: $isImportant)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, isImportant);
...
abstract class _LoginData implements LoginData {
  const factory _LoginData({required final int id, final bool isImportant}) =
      _$_LoginData;
